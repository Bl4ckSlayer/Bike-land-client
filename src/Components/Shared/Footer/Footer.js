      ...
      <div className="container d-grid mt-5">
        <div className="row my-3 text-white">
          ...
          <div className="col-md-3 col-sm-12 my-3">
            ...
            <div>
              <p>
                ...
                House-19, Road-23, Rupnagar Residencial, Mirpur-2, Dhaka,
                Bangladesh
              </p>
              <p>
          ...
          <div className="col-md-3 col-sm-12 my-3">
            ...
            />
            <Button
              className="text-white my-3 w-50 mx-auto d-block"
              variant="info"
            >
              Get Notified
            </Button>
        ...
        <div className="row text-center text-white">
          <p>
            ...
            <span className="text-info">Pro Tech Gear</span> All Rights
            Reserved.
          </p>
        </div>
      </div>
